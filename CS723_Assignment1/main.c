...
// Storage arrays
static volatile reactionTimes[REACTION_ARRAY_SIZE] = {0};
static volatile frequencyData[FREQUENCY_DATA_QUEUE_SIZE] = {0};
static volatile rateOfChangeData[FREQUENCY_DATA_QUEUE_SIZE] = {0};
